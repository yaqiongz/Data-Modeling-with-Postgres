...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id varchar PRIMARY KEY, start_time varchar, user_id varchar, level varchar, song_id varchar NOT NULL, artist_id varchar, session_id varchar, location varchar, user_agent varchar)
""")
